...
class Checkpoint:
    ...
    def load_decoder(checkpoint, training_mode=True):
        ...
        decoder = DecoderNetwork(n_states=n_states, image_shape=image_shape)
    ...
    def load_encoder(checkpoint, training_mode=True):
        ...
        encoder = EncoderNetwork(n_states=n_states, image_shape=image_shape)
    ...
    def load_transition(checkpoint, training_mode=True):
        ...
        transition = TransitionNetwork(n_states=checkpoint["n_states"], n_actions=checkpoint["n_actions"])
    ...
    def load_critic(checkpoint, training_mode=True, n_states_key="n_states", network_key="critic_net"):
        ...
        """
        # Load critic network.
        critic = CriticNetwork(n_states=checkpoint[n_states_key], n_actions=checkpoint["n_actions"])
    ...
    def load_policy(checkpoint, training_mode):
        ...
        """
        # Load critic network.
        policy = PolicyNetwork(image_shape=checkpoint["image_shape"], n_actions=checkpoint["n_actions"])
